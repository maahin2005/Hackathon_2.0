    ...
    <section className="w-screen min-h-screen flex flex-col lg:flex-row items-center justify-center px-8 lg:px-24 bg-gray-900 text-white pb-12 pt-12">
      ...
      >
        ...
        <p className="text-lg text-gray-300">
          Stand out from the crowd! Our AI-powered platform showcases your
          GitHub projects, contributions, and real-world skills to top
          recruiters. 🚀
        </p>
        <ul className="text-lg text-gray-300 space-y-3">
          <li>
            🔹 Get matched with companies that value your coding skills and
            expertise.
          </li>
          <li>
            🔹 Showcase your GitHub contributions and real-world problem-solving
            ability.
          </li>
        ...
        <button
          ...
          className="cursor-pointer mt-4 px-6 py-3 text-lg font-semibold  rounded-full transition-all duration-500 ease-in-out 
