...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-xl md:text-2xl font-bold text-center ">
        ...
        <div className="flex flex-col gap-4 w-full md:w-80">
          <button
            ...
            className={`w-full px-6 py-3 text-lg font-semibold rounded-xl transition-all duration-500 
              ${activeRole === "recruiter" 
                ? "border-2 border-blue-600 bg-gradient-to-r from-blue-700 via-blue-600 to-blue-800 text-white shadow-xl shadow-blue-600/50 transform hover:scale-105" 
          ...
          <button
            ...
            className={`w-full px-6 py-3 text-lg font-semibold rounded-xl transition-all duration-500 
              ${activeRole === "jobseeker" 
                ? "border-2 border-green-600 bg-gradient-to-r from-green-700 via-green-600 to-green-800 text-white shadow-xl shadow-green-600/50 transform hover:scale-105" 
      ...
      {/* Right Section */}
      <div className="relative z-10 pt-4 pb-6 px-6 md:p-8 bg-gray-900/40 border border-gray-500/50 backdrop-blur-lg shadow-md w-full max-w-2xl min-h-[350px] flex flex-col items-center gap-4 justify-center text-center rounded-lg mt-6 md:mt-0">
        {activeRole === "recruiter" ? (
