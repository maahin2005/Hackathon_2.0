// import ImgRecruiter from "C:/Users/Dell/Desktop/Hackathon_2.0/frontend/src/assets/images/4565.jpg"
      ...
      <section className="w-screen min-h-screen flex flex-col lg:flex-row items-center justify-evenly px-8 lg:px-24 bg-black text-white">
        ...
        >
          ...
          <p className="text-lg text-gray-300">
            Tired of sifting through endless resumes? Our AI-powered platform analyzes GitHub repositories to evaluate candidates based on real skills, efficiency, and contributions—not just words on paper! 🎯
          </p>
          <ul className="text-lg text-gray-300 space-y-3">
            <li>🔹 Set precise hiring criteria and let our system match you with the best-fit developers.</li>
            <li>🔹 Instantly assess expertise with deep GitHub insights—no more guesswork!</li>
            <li>🔹 Hire with confidence based on real-world performance and project impact.</li>
          </ul>
        ...
        <div
          ...
          data-aos="slide-left" data-aos-anchor-placement="center-bottom" data-aos-once="false"// Animation effect
          data-aos-duration="1000" // Duration in milliseconds
        >
          <img 
