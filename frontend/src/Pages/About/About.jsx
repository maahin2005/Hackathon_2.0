...
const AboutUs = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="py-4 min-h-screen  flex flex-col items-center justify-center  text-center ">
        <div className="text-center w-full my-8  flex-grow">
          <h1 className="font-[Kanit] text-7xl font-bold mb-8 bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent mt-14">
            About Us
          </h1>
