...
function RecruiterDashboard() {
  return (
    <div className="my-20 flex justify-center">
      <div class="max-w-4xl w-full rounded-lg overflow-hidden shadow-lg bg-white">
        ...
        <div class="text-center mt-16">
          ...
          <p class="text-sm text-gray-600">Senior Recruiter at TechCorp</p>
        </div>
        ...
        <div class="flex justify-center mt-6 space-x-8">
          ...
          <div class="text-center">
            ...
            <p class="text-sm text-gray-600">Candidates Placed</p>
          </div>
          <div class="text-center">
        ...
        <div class="px-8 pt-4 pb-8">
          <button class="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-3 px-6 rounded-lg shadow-md transition-all duration-300">
            Contact John
          </button>
        </div>
      </div>
