...
const EmployeeProfile = ({ employee }) => {
  ...
  console.log(employee.githubUsername, import.meta.env.VITE_GITHUB_ACCESS_TOKEN)

  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get(`https://api.github.com/users/${employee.githubUsername}/repos`, {
          headers: {
            Authorization: `token ${import.meta.env.VITE_GITHUB_ACCESS_TOKEN}`, // Use OAuth token if needed
          },
        });
